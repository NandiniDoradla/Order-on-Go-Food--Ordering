import app_logo from '/src/assets/images/mealmate.png'
    ...
    <div id="footer-container" className="screen-max-width">
      <div id='contact' className="wrapper px-2 sm:px-10 flex flex-wrap gap-x-5 gap-y-10 w-full my-10">
        ...
        <section id="footer-contact" className='w-full sm:w-1/3 text-white'>
          <address className='location text-orange-300'>
            <i className="fa-solid fa-location-dot"></i> No 5, Car Street, St Thomas Mount, Chennai - 600027
          </address>
          <address className='mobile'>
            <i className="fa-solid fa-phone-volume"></i> +91 7530049748
          </address>
          <address className='mail'>
            <i className="fa-solid fa-square-envelope"></i> dhanasekarraman5@gamil.com
          </address>
      ...
      <div className="copyright pt-6">
        <p className='text-center text-orange-400'>
          Copyright 2024 <i className="fa-solid fa-copyright"></i> Mealmate.com - All Right Reserved.
        </p>
      </div>
    </div>
  )
